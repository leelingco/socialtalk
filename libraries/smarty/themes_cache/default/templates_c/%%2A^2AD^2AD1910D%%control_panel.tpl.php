<?php /* Smarty version 2.6.26, created on 2012-12-19 23:14:40
...
<?php if ($this->_tpl_vars['total'] == 100): ?>+<?php endif; ?> <?php echo @_MORE; ?>
</a></div>
                  <div class = "hidden_lesson_registrations" style = "display:none"><a href = "javascript:void(0)" onclick = "$$('div.hidden_lesson_registrations').each(function (s) {s.hide()});Element.extend(this).up().previous().show();"><?php echo $this->_tpl_vars['total']-10; ?>
 <?php echo @_LESS; ?>
</a></div>
     <?php endif; ?>
...
<?php if ($this->_tpl_vars['total'] == 100): ?>+<?php endif; ?> <?php echo @_MORE; ?>
                  ...
                  <div class = "hidden_course_registrations" style = "display:none"><a href = "javascript:void(0)" onclick = "$$('div.hidden_course_registrations').each(function (s) {s.hide()});Element.extend(this).up().previous().show();"><?php echo $this->_tpl_vars['total']-10; ?>
 <?php echo @_LESS; ?>
</a></div>
     <?php endif; ?>
