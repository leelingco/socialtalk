<?php /* Smarty version 2.6.26, created on 2012-12-21 01:09:57
...
?>
       ...
       <?php $_from = $this->_tpl_vars['T_SIDE_INNERTABLE_MODULES']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['module_inner_tables_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['module_inner_tables_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['moduleItem']):
        $this->_foreach['module_inner_tables_list']['iteration']++;
?>
