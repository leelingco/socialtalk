<?php /* Smarty version 2.6.26, created on 2013-03-23 11:24:41
...
">
                     <td>
                     <a name="message_<?php echo $this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['id']; ?>
"></a>
...
"/></a>
                   <?php endif; ?>
                   <?php if ($_SESSION['s_type'] == 'administrator' || ( $_SESSION['s_type'] == 'professor' && $this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['user_type'] == 'student' ) || $_SESSION['s_login'] == $this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['users_LOGIN']): ?>
                          <a href = "<?php echo $_SERVER['PHP_SELF']; ?>
