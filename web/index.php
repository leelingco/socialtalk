			...
			<div class='content'>
				<div class='left'>
					...
					<ul class='steps'>
						...
						<li><img src="images/circle-3.png" alt="3" class='step-image'><a>send the invite</a><span id='twitter-invite-to'></span><br/><textarea id='share-url'></textarea><button class='button' id='send-invite' onclick='sendTwitterInvite()'>Send</button></li>
				</div>
