	...
	$.post(tokliveParams.baseURL + "php/GetSession.php", {sessionId:theSessionId},
		function(data){
			try{
				...
				alert("OpenTok failed to initialize"+tokliveParams.baseURL + "php/GetSession.php"+e.message+data);
			}
		}, "json");
}
...
function initializeTokBoxSession(){
	...
	initializeStreamContainers();
	logMessage("initializeTokBoxSession session: " + theSessionId + "isPanelThreeOpen::" + isPanelThreeOpen);
